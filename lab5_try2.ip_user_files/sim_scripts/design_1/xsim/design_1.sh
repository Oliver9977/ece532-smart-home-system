...
{
  file="xsim.ini"
  lib_map_path="/home/oliver/Xilinx/Vivado/2018.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xbip_utils_v3_0_9 c_reg_fd_v12_0_5 xbip_dsp48_wrapper_v3_0_4 xbip_pipe_v3_0_5 xbip_dsp48_addsub_v3_0_5 xbip_addsub_v3_0_5 c_addsub_v12_0_12 xbip_bram18k_v3_0_5 mult_gen_v12_0_14 axi_utils_v2_0_5 cordic_v6_0_14)
